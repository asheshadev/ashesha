...
function elisc_tm_modalbox() {
    "use strict";
    jQuery('.elisc_tm_all_wrap').prepend('<div class="elisc_tm_modalbox"><div class="box_inner"><div class="close"><a href="#"><i class="icon-cancel-circled"></i></a></div><div class="description_wrap"></div></div></div>');
}
...
function elisc_tm_modalbox_portfolio() {
    ...
    button.on('click', function() {
        ...
        var imageWidthPercentage = 100; // Set the desired width percentage
        var imageHeightPercentage = 100; // Set the desired height percentage
