"function" != typeof Object.create && (Object.create = function(t) {
    ...
    function(t, e, o) {
        var i = {
            ...
            response: function() {
                var o, i, s = this;
                return !0 === s.options.responsive && (i = t(e).width(), s.resizer = function() {
            ...
            jumpTo: function(t) {
                var e = this;
                "function" == typeof e.options.beforeMove && e.options.beforeMove.apply(this, [e.$elem]), t >= e.maximumItem || -1 === t ? t = e.maximumItem : 0 >= t && (t = 0), e.swapSpeed(0), !0 === e.browser.support3d ? e.transition3d(e.positionsInArray[t]) : e.css2slide(e.positionsInArray[t], 1), e.currentItem = e.owl.currentItem = t, e.afterGo()
            },
            afterGo: function() {
                var t = this;
            ...
            checkBrowser: function() {
                ...
                r.style.cssText = "  -moz-transform:" + a + "; -ms-transform:" + a + "; -o-transform:" + a + "; -webkit-transform:" + a + "; transform:" + a, t = /translate3d\(0px, 0px, 0px\)/g, s = null !== (i = r.style.cssText.match(t)) && i.length >= 1, n = "ontouchstart" in e || e.navigator.msMaxTouchPoints, this.browser = {
                    support3d: s,
                    isTouch: n
                }
            },
            ...
            gestures: function() {
                ...
                function s(e) {
                    "on" === e ? (t(o).on(r.ev_types.move, n), t(o).on(r.ev_types.end, a)) : "off" === e && (t(o).off(r.ev_types.move), t(o).off(r.ev_types.end))
                }

                function n(s) {
                    var n, a, p = s.originalEvent || s || e.event;
                    r.newPosX = i(p).x - l.offsetX, r.newPosY = i(p).y - l.offsetY, r.newRelativeX = r.newPosX - l.relativePos, "function" == typeof r.options.startDragging && !0 !== l.dragging && 0 !== r.newRelativeX && (l.dragging = !0, r.options.startDragging.apply(r, [r.$elem])), (r.newRelativeX > 8 || r.newRelativeX < -8) && !0 === r.browser.isTouch && (void 0 !== p.preventDefault ? p.preventDefault() : p.returnValue = !1, l.sliding = !0), (r.newPosY > 10 || r.newPosY < -10) && !1 === l.sliding && t(o).off("touchmove.owl"), n = function() {
                        return r.newRelativeX / 5
                    }, a = function() {
                        return r.maximumPixels + r.newRelativeX / 5
                    }, r.newPosX = Math.max(Math.min(r.newPosX, n()), a()), !0 === r.browser.support3d ? r.transition3d(r.newPosX) : r.css2move(r.newPosX)
                }

                function a(o) {
                    var i, n, a, p = o.originalEvent || o || e.event;
                    p.target = p.target || p.srcElement, l.dragging = !1, !0 !== r.browser.isTouch && r.$owlWrapper.removeClass("grabbing"), r.dragDirection = r.owl.dragDirection = r.newRelativeX < 0 ? "left" : "right", 0 !== r.newRelativeX && (i = r.getNewPosition(), r.goTo(i, !1, "drag"), l.targetElement === p.target && !0 !== r.browser.isTouch && (t(p.target).on("click.disable", function(e) {
                        e.stopImmediatePropagation(), e.stopPropagation(), e.preventDefault(), t(e.target).off("click.disable")
                    }), a = (n = t._data(p.target, "events").click).pop(), n.splice(0, 0, a))), s("off")
                }
                var r = this,
                    l = {
                        offsetX: 0,
                ...
                r.isCssFinish = !0, r.$elem.on(r.ev_types.start, ".owl-wrapper", function(o) {
                    var n, a = o.originalEvent || o || e.event;
                    ...
                    if (!(r.itemsAmount <= r.options.items)) {
                        ...
                        !1 !== r.options.autoPlay && e.clearInterval(r.autoPlayInterval), !0 === r.browser.isTouch || r.$owlWrapper.hasClass("grabbing") || r.$owlWrapper.addClass("grabbing"), r.newPosX = 0, r.newRelativeX = 0, t(this).css(r.removeTransition()), n = t(this).position(), l.relativePos = n.left, l.offsetX = i(a).x - n.left, l.offsetY = i(a).y - n.top, s("on"), l.sliding = !1, l.targetElement = a.target || a.srcElement
                    }
                })
            },
            ...
            closestItem: function() {
                ...
                return t.each(o, function(n, a) {
                    i - e.itemWidth / 20 > o[n + 1] && i - e.itemWidth / 20 < a && "left" === e.moveDirection() ? (s = a, e.currentItem = !0 === e.options.scrollPerPage ? t.inArray(s, e.positionsInArray) : n) : i + e.itemWidth / 20 < a && i + e.itemWidth / 20 > (o[n + 1] || o[n] - e.itemWidth) && "right" === e.moveDirection() && (!0 === e.options.scrollPerPage ? (s = o[n + 1] || o[o.length - 1], e.currentItem = t.inArray(s, e.positionsInArray)) : (s = o[n + 1], e.currentItem = n + 1))
                }), e.currentItem
            },
            ...
            lazyPreload: function(t, o) {
                function i() {
                    t.data("owl-loaded", "loaded").removeClass("loading"), o.removeAttr("data-src"), "fade" === n.options.lazyEffect ? o.fadeIn(400) : o.show(), "function" == typeof n.options.afterLazyLoad && n.options.afterLazyLoad.apply(this, [n.$elem])
                }
                var s, n = this,
                    a = 0;
                "DIV" === o.prop("tagName") ? (o.css("background-image", "url(" + o.data("src") + ")"), s = !0) : o[0].src = o.data("src"),
                    function t() {
                        a += 1, n.completeImg(o.get(0)) || !0 === s ? i() : 100 >= a ? e.setTimeout(t, 100) : i()
                    }()
            },
            autoHeight: function() {
                function o() {
                ...
                void 0 !== n.get(0) ? (i = 0, function t() {
                    i += 1, s.completeImg(n.get(0)) ? o() : 100 >= i ? e.setTimeout(t, 100) : s.wrapperOuter.css("height", "")
                }()) : o()
            },
