google.maps.__gjsload__('overlay', function(_) {
    var JD = function(a) {
        ...
        Fma = function(a, b) {
            ...
            a.bindTo("panes", f);
            e = () => _.Pm(d.Eh);
            c.Rh = [_.hk(a, "panes_changed", e), _.hk(f, "zoom_changed", e), _.hk(f, "offset_changed", e), _.hk(b, "projection_changed", e), _.hk(f, "projectioncenterq_changed", e)];
            _.Pm(d.Eh);
            b instanceof _.Ek ? (_.ol(b, "Ox"), _.ml(b, 148440)) : b instanceof _.Kl && (_.ol(b, "Oxs"),
                _.ml(b, 181451))
        },
        Kma = function(a) {
            if (a) {
                ...
                if (Gma(a) !== b && b && b instanceof _.Ek) {
                    const c = b.__gm;
                    c.overlayLayer ? a.__gmop = new Hma(b, a, c.overlayLayer) : c.Gg.then(({
                        lh: d
                    }) => {
                        const e = new Ima(b, d);
                        d.Ai(e);
    ...
    JD.prototype.changed = function(a) {
        "outProjection" != a && (a = !!(this.get("offset") && this.get("projectionTopLeft") && this.get("projection") && _.Vi(this.get("zoom"))), a == !this.get("outProjection") && this.set("outProjection", a ? this.Fg : null))
    };
    var LD = {};
    _.Ga(Ema, _.yk);
    LD.Tk = function(a) {
